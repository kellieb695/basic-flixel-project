...
class PlayState extends FlxState
{
	...
	{	
		...
		screensaverHero1.velocity.x = FlxG.random.float(25,100);
		screensaverHero1.velocity.y = FlxG.random.float(25,100);
		screensaverHero2.velocity.x = FlxG.random.float(25,100);
		screensaverHero2.velocity.y = FlxG.random.float(25,100);
		screensaverHero3.velocity.x = FlxG.random.float(25,100);
		screensaverHero3.velocity.y = FlxG.random.float(25,100);
